...
format:
  revealjs:
    df-print: kable
    footer: "DSAN 5300 Week 8: {{< var w08.footer >}}"
...
* But should **not** be used on its own! For reasons we'll see shortly
  * (Like "Linear Probability Models", MMCs highlight problem that [usable method] solves!)
...
* Any line which **perfectly separates** positive from negative cases is a **separating hyperplane** \[[Demo](https://observablehq.com/@jpowerj/separating-hyperplanes)\]
...
#| label: spiral-svm
#| crop: false
#| fig-cap: Based on code from @boehmke_handson_2019, Ch 14
